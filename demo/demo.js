...
function addCodeplayExamplesDemo(domElement) {
  ...
  addElement("div", "This examples demo is not very user friendly on small&nbsp;screens. We would recommend you try it out on a larger&nbsp;display.", "note-small-screens");
  addElement("p", "<strong>GitHub : <a href='https://github.com/madeofnumbers/10-codeplay/'>https://github.com/madeofnumbers/10-codeplay/</a></strong>");
  ...
  addExample({
    ...
    use: () => {
      let custom = getValue("makerCustom");
      // ===== parse custom string to support copy/paste of entire share link from 10 / MAKER =====
      if (custom.split("c=").length > 1) {
        custom = custom.split("c=")[1].split("?")[0];
      }
      mon10.loadMaker(custom);
      return ""
    },
  ...
  addElement("p", "<strong>mon10.getXY(x, y)</strong><br><ul class='input'><li><strong>x, y</strong> <em>// (int, int) position : top-left corner of the grid is (0, 0)</em></li></ul>result :<strong><ul class='result'><li>block: 1</strong> <em>// is a non-numeric block tile</em></li><li><strong>empty: 1</strong> <em>// is empty, no tile at that position</em></li><li><strong>number:</strong> value <em>// (int) numeric tile, including 'number: 0' which is value 0</em></li><li><strong>move:</strong> direction <em>// (int) permitted directions : 0 = none, 1 = up, 2 = right, 3 = down, 4 = left, 5 = up/down, 6 = left/right, 7 = all</em></li></ul>");
  addElement("p", "<strong>mon10.moveXYD(x, y, d)</strong><ul class='input'><li><strong>x, y</strong> <em>// (int, int) position : top-left corner of the grid is (0, 0)</em></li><li><strong>d</strong> <em>// (int) direction : 1 = up, 2 = right, 3 = down, 4 = left</em></li></ul>result :<ul class='result'><li><strong>x:, y:</strong> <em>// (int, int) tile moved to this new position</em></li><li><strong>fail: 1</strong> <em>// tile could not be moved</em></li><li><strong>fail: 2</strong> <em>// tile could be moved but would result in an illegal value below -10 or above 10</em></li></ul>");
  addElement("p", "<strong>mon10.loadMaker(c)</strong><ul class='input'><li><strong>c</strong> <em>// (string) custom : for test purposes you can load puzzles created in <a href='https://madeofnumbers.com/10/maker/' target='_blank'>10 / MAKER</a><br>From a share link the parameter '<strong>c=</strong>' is the custom string - e.g. from <a href='https://madeofnumbers.com/10/?c=3MpDvCvDpM' target='_blank'>https://madeofnumbers.com/10/?c=3MpDvCvDpM</a> the custom string is&nbsp;<strong>3MpDvCvDpM</strong> - an empty or invalid string will result in the daily puzzle being loaded</em></li></ul>");
  ...
  addElement("p", "Script : <a href='https://github.com/madeofnumbers/10-codeplay/blob/main/examples/grid-summary/mon10-codeplay-example-grid-summary.js'>examples/grid-summary/mon10-codeplay-example-grid-summary.js</a>");
  ...
  addElement("p", "Script : <a href='https://github.com/madeofnumbers/10-codeplay/blob/main/examples/random-moves/mon10-codeplay-example-random-moves.js'>examples/random-moves/mon10-codeplay-example-random-moves.js</a>");
