...
function addCodeplayExamplesDemo(domElement) {
  ...
  addHtml("h1", "10 / CODEPLAY : write code to solve puzzles");
  addHtml("p", "About : example code to interact with <a href='https://madeofnumbers.com/10/' target='_blank'>madeofnumbers/10</a>, a game where the player slides numbers into each other to make 10s. Once all the numbers have been combined, the player has solved the puzzle.")
  addHtml("p", "The <strong>Mon10</strong> object from <strong>https://madeofnumbers.com/10/mon10-latest.min.js</strong> provides the following methods.");
  ...
  addHtml("h1", "Example : randomMoves()");
  addHtml("p", "Uses mon10.getXY(), mon10.moveXYD(), mon10.nonzero() and mon10.size() to make entirely random moves with almost no chance of solving a puzzle");
  addHtml("p", "Script : <a href='../examples/random-moves/mon10-codeplay-example-random-moves.js' target='_blank'>examples/random-moves/mon10-codeplay-example-random-moves.js</a>");
  addHtml("p", "", "html-random-moves-log");
  addExample({
    name: "randomMoves",
    params: [{
      type: "number",
  ...
  // ===== legal notes =====
  addHtml("hr");
  addHtml("div", "<p class='small'>The puzzle game 'madeofnumbers/10' and its editor '10 / MAKER' are &copy;2024 IOJOE / madeofnumbers. All rights reserved.<br>'10 / CODEPLAY' examples are open-source under the MIT license &copy;2024 madeofnumbers</p>")
